...
**Definition**:
An endearing term for a kigurumi, jokingly as the masks are larger than a normal human head. Sometimes used to refer to an insufficiently padded mask.
...
**Definition**:
Shorthand term for a **cos**play**er**. Not specific to Kigurumi.
...
**Definition**:
A kigurumi performer, relating to the doll-like nature of kigurumi, akin to [#coser](#coser).
...
**Definition**:
When a mask does not have sufficient padding at the front for the wearer, leading the mask to give the appearance of a hunched over posture.

**Related**:
[Neck eater](#neck-eater)
...
**Definition**:
The titular mask of a kigurumi costume, the most involved component of kigurumi cosplay.

### **Kigurumi performer**

**Definition**:
The kigurumi wearer themselves.

**Context**:
One of several words that refers to people who don a kigurumi mask and hadatai.
