...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| Kigurumi Mask     | [KigLover](https://kiglover.com/)                                                                                                                                                                                                                          | $760+ shipped, tariffs included |
...
- **Mask.** [KigLover](https://kiglover.com/) (MidDreamKigu, currently rebranding) is a Chinese maker targeting western audiences. $760+ is a realistic number _shipped_, with tariffs for a basic mask. Character complexity and destination change this. See the [maker list](../Buy/makers.md) for other options.
