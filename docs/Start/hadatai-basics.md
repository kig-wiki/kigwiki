...
| **Fit**           | Usually made to measure (measure with padding on), some makers do offer generic sizes                                                                                   | Almost always generic sizing, with a more neutral one-size-fits-all design rather than for exaggerated (padded) anime physique. Should fit like a second skin |
