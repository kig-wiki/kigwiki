...
title: "Buying a Used Kigurumi Mask: Guide & Safety Tips"
...
tags:
  ...
  - secondhand
sidebar_position: 1
description: "Thinking about a secondhand kigurumi mask? Where used masks are sold, what to check before you pay, and the scams and risks to avoid."
---

# Buying Used Kigurumi Masks

A used kigurumi mask can be one of the most accessible ways to owning your own kig mask. Sometimes a kig just doesn't wear one of their masks so often, don't have the connection to a particular character anymore, or are just looking to clear space for future masks. These can present a rather quick and affordable way to get your hands on a kigurumi mask if things look right.
...
- **Fake Listings**: Some scammers will use fake listings to get people to buy a mask they don't actually have. Mask maker's photos or re-used social media photos are one of the most common red flags. If you can find the owner of the mask on social media, see if its really them selling the mask.
...
- **"Minor Damage"**: Be aware some 'minor damage' isn't always so minor and can be a huge undertaking to fix if its a problem with the mask or paint itself. If you are considering a mask that needs a bit of a touch up, ask the seller if they can provide photos of the damage.
